...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		*/
		[_LAYER0] = LAYOUT_65_ansi( /* Base */
		    ...
		    KC_LCTL, 	   KC_LALT,  KC_LGUI,                KC_SPC,                KC_RGUI, MO(1),    KC_RALT,  KC_LEFT,           KC_DOWN,   KC_RIGHT),
	   ...
	   */
		[_LAYER1] = LAYOUT_65_ansi( /* FN */
			KC_GESC,       KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,  KC_F12,  KC_DEL,   KC_GESC,\
